...
<form action="{{URL::to('/post_suayeucau')}}" method="POST">@csrf
<br>
  ...
  <div class="card-header row">
    ...
    <div class="col-8" id="tag_nutchucnang">
      <div style="text-align:right;" > 
              ...
              <a href="{{URL::to('/chuyentiepyeucau/'.$data->id_yeucau)}}"><button class="btn btn-primary" type="button" id="btn_chuyentiep">Chuyển tiếp</button></a>
      </div>
    </div>
...
<div class="row">
  <div class="col-3">
          ...
          <select type="text" class="form-control" id="loaithue" name="loaithue" required>
            <?php 
            $loaithue1 ="";$loaithue2 ="";$loaithue3 ="";$loaithue4 ="";$loaithue5 ="";
              switch ($data->loaithue) {
                case '1': $loaithue1='selected';break;
                case '2': $loaithue2='selected';break;
                case '3': $loaithue3='selected';break;
                case '4': $loaithue4='selected';break;
                case '5': $loaithue5='selected';break;
              }
            ?>


            <option value="1" {{$loaithue1}}>Biên bản xác nhận/ Có đặt cọc</option>
            <option value="2" {{$loaithue2}}>Kí hợp đồng, có đặt cọc</option>
            <option value="3" {{$loaithue3}}>Biên bản xác nhận/ Không đặt cọc</option>
            <option value="4" {{$loaithue4}}>Kí hợp đồng, không đặt cọc, thanh toán sau</option>
            <option value="5" {{$loaithue5}}>Kí hợp đồng, không đặt cọc, thanh toán trước</option>
          </select>
        </div>
        <div class="col-2">
          <i class="fas fa-money-bill-alt"> Giá trị đặt cọc </i> 
          <input type="text" value="{{$data->tiencoc}}" name="tiencoc" id="tiencoc" class="form-control">
        </div>
   <div class="col-7">
    Địa chỉ:
...
function  doitien(){
  $("#tiencoc").value = $("#tiencoc").value.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
}
function xoadong(){
